                             ...
                             <div class="row justify-content-center">
                                 <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                     ...
                                     <form class="mx-1 mx-md-4" method="POST" action="{{ route('register-owner') }}"
                                         ...
                                         <div class="form-outline mb-3">
                                             <label for="store_name" class="form-label">Nama Lapangan</label>
                                             <input type="text" class="form-control" name="store_name"
                                                 id="store_name" placeholder="Nama toko" value="{{ old('store_name') }}"
                                                 required>
                                             @error('store_name')
                                                 <small class="text-danger">{{ $message }}</small>
                                             @enderror
                                         ...
                                         <div class="form-outline mb-3">
                                             <label for="store_address" class="form-label">Alamat Lapangan</label>
